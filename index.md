...
![](reference/figures/README-mixnorm-1.png)
...
![](reference/figures/README-package_logo-1.png)
...
function groups a given `data.frame` based on the values in a specified
column:
