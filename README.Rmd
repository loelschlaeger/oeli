...
The package includes helpers for different tasks and objects. Below are some demos. Clicking the headings will take you to the corresponding vignette, where you'll find detailed documentation on all the helpers currently available in that category.
