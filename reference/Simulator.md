...
#> Saving backup to path /tmp/Rtmp2krXfN/backup_2026-09-07-07-19-31.
...
#>   <int> <drtn>         <list>           <list>   
#> 1     1 0.5169322 secs <named list [1]> <dbl [1]>
#> 2     2 0.2303023 secs <named list [1]> <dbl [1]>
#> 3     3 0.6744189 secs <named list [1]> <dbl [1]>
#> 4     4 0.6663916 secs <named list [1]> <dbl [1]>
