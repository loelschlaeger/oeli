...
#> Saving backup to path /tmp/RtmpcTy2bm/backup_2026-09-24-07-30-24.
...
#>   <int> <drtn>         <list>           <list>   
#> 1     1 0.5169520 secs <named list [1]> <dbl [1]>
#> 2     2 0.2302897 secs <named list [1]> <dbl [1]>
#> 3     3 0.6744120 secs <named list [1]> <dbl [1]>
#> 4     4 0.6663854 secs <named list [1]> <dbl [1]>
